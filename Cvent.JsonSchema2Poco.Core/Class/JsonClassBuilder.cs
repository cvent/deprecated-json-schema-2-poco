...
{
    class JsonClassBuilder
    {
        public JsonClass Build(JsonSchema schema, string className, string schemaNamespace)
        {
            ...
            {
                var jsonProperty = JsonProperty.CreateProperty(schemaNamespace, schemaProperty.Key, schemaProperty.Value);
