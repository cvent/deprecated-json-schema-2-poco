...
namespace Cvent.JsonSchema2Poco.Class.Property.Types
{
    ...
    class ObjectPropertyType : JsonSchemaPropertyType
    {
        ...
        {
            var jsonClass = JsonSchemaClass.CreateFromSchema(info.Definition, info.Name, info.Namespace);
        ...
        {
            return new List<JsonSchemaClass> {JsonSchemaClass.CreateFromSchema(info.Definition, info.Name, info.Namespace)};
        }
    }
}
