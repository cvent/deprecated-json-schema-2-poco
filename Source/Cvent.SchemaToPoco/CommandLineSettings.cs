...
namespace Cvent.SchemaToPoco
{
    ...
    {
        /// <summary>Location of root JSON schema file.</summary>
        public string JsonSchemaFileLocation { get; set; }

        /// <summary>Namespace to set for generated files.</summary>
        public string Namespace { get; set; }

        /// <summary>Directory to output generated files.</summary>
